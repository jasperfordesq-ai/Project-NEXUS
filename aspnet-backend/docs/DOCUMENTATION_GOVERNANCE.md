...
| Mobile app banked score, blockers, and what a green pipeline proves | [`CURRENT_MOBILE_PRODUCTION_STATUS.md`](../../mobile/docs/CURRENT_MOBILE_PRODUCTION_STATUS.md) | Link to it; do not publish a competing mobile score. 🔴 Rubric **M1 measures how much of the product is proved to work**; the superseded mobile scorecards measured code quality. Different questions — never subtract, average, or describe M1 as a rise or fall from one of them |
| Mobile work list and completion denominator | [`MOBILE_JOURNEY_LEDGER.md`](../../mobile/docs/MOBILE_JOURNEY_LEDGER.md) | Pick mobile work up there. Never publish a competing journey count or total. 🔴 Its 140 rows answer "does the mobile app work at all"; Tier 6 of `JOURNEY_CERTIFICATION_LEDGER.md` answers "does it behave identically against ASP.NET". Two denominators, never blended |
| Mobile plan, phase order, and exit criteria | [`MOBILE_ROADMAP.md`](../../mobile/docs/MOBILE_ROADMAP.md) | Link to it; do not publish a competing phase order. Every phase ends in a ledger status change, not a description of effort |
| How a mobile journey is proved on a device | [`MOBILE_TEST_HARNESS.md`](../../mobile/docs/MOBILE_TEST_HARNESS.md) | Reuse its harness, fixture accounts, and trap list rather than rediscovering them |
