...
return [
    ...
    'account_under_minimum_age' => 'This platform is for adults aged :age and over, so this account cannot be used. Please contact your community if you think this is a mistake.',
    'date_of_birth_under_minimum_age' => 'This platform is for adults aged :age and over. Please enter a date of birth that shows you are at least :age.',
    'guardian_consent_retired' => 'Guardian consent is no longer used, because this platform is for adults aged :age and over.',
    ...
    'impersonation_token_required'          => 'An impersonation token is required',
    'impersonation_token_invalid'           => 'This impersonation link has expired or has already been used',
    'impersonation_token_wrong_tenant'      => 'This impersonation link was not issued for this community',
    'impersonation_target_unavailable'      => 'This member can no longer be impersonated',
    'impersonation_actor_unavailable'       => 'The administrator who started this impersonation no longer has permission',
    'impersonation_session_not_found'       => 'No impersonated session to end',
    ...
    'supporter_message_view_purpose_required' => 'Say briefly why you need to view these messages — every viewing is recorded',
    ...
    'super_parent_not_found'               => 'Parent tenant not found',
    'super_parent_no_subtenants'           => 'Parent tenant does not allow sub-tenants',
    'super_max_depth_exceeded'             => 'Maximum hierarchy depth exceeded',
    'super_tenant_name_required'           => 'Tenant name is required',
    'super_slug_in_use'                    => "Slug ':slug' is already in use",
    'super_domain_in_use'                  => "Domain ':domain' is already in use",
    'super_domains_must_differ'            => 'Primary and accessible domains must be different',
    'super_delete_master_forbidden'        => 'Cannot delete the Master tenant',
    'super_delete_has_children'            => 'Cannot delete a tenant with active sub-tenants. Deactivate or move them first.',
    'super_move_master_forbidden'          => 'Cannot move the Master tenant',
    'super_move_self_parent'               => 'Cannot move a tenant to be its own parent',
    'super_move_into_descendant'           => 'Cannot move a tenant under one of its own descendants',
    'super_move_path_missing'              => 'Cannot move tenant: hierarchy path data is missing. Re-save the affected tenants to rebuild paths.',
    'super_new_parent_not_found'           => 'New parent tenant not found',
    'super_user_not_in_this_tenant'        => 'User does not belong to this tenant',
    'super_tenant_no_subtenants'           => 'Tenant does not support sub-tenants',
    'super_tenant_create_failed'           => 'Failed to create tenant. The error has been logged for investigation.',
    'super_tenant_update_failed'           => 'Failed to update tenant. The error has been logged for investigation.',
    'super_tenant_delete_failed'           => 'Failed to delete tenant. The error has been logged for investigation.',
    'super_tenant_move_failed'             => 'Failed to move tenant. The error has been logged for investigation.',
    'super_toggle_subtenants_failed'       => 'Failed to change the sub-tenant capability. The error has been logged for investigation.',
    'super_grant_super_admin_failed'       => 'Failed to grant super admin. The error has been logged for investigation.',
    'super_revoke_super_admin_failed'      => 'Failed to revoke super admin. The error has been logged for investigation.',
    ...
    'super_move_user_already_in_tenant'    => 'This user is already a member of that community.',
    'super_move_user_email_conflict'       => 'The destination community already has an account with this email address.',
    'super_move_user_username_conflict'    => 'The destination community already has an account with this username.',
    'super_move_user_history_locked'       => 'This user has event records (registrations, invitations or consents) in their current community that must stay there, so the account cannot be moved.',
    'super_move_target_tenant_inactive'    => 'The destination community is not active.',
    'super_move_user_group_ownership_required' => 'This user is the only owner of one or more groups in their current community. Transfer group ownership to another member first, then move them.',
    'super_move_user_exchanges_in_flight'  => 'This user has exchanges that are underway, awaiting confirmation or in dispute. These must be completed or resolved before the account can be moved.',
    'exchange_party_unavailable'           => 'The other member in this exchange is no longer part of this community, so the credits cannot be transferred.',
    'listing_owner_unavailable'            => 'The member who posted this listing has moved to a different community, so it can no longer be requested.',
    'exchange_closed_member_moved'         => 'Your exchange request for ":title" was closed because the other member moved to a different community.',
    ...
    'job_time_credits_invalid'             => 'Time credits must be a number greater than 0 with at most 2 decimal places',
    'job_time_credits_max'                 => 'Time credits cannot exceed :max hours',
    ...
    'job_offer_employer_insufficient_balance' => "This offer can't be accepted yet because the employer doesn't have enough time credits to pay for the job.",
    ...
    'group_challenge_active_limit'      => 'This group already has :max live challenges. Wait for one to finish or cancel one before creating another.',
    ...
    'caring_sub_region_slug_invalid'           => 'Enter a sub-region name that contains at least one letter or number.',
    'caring_sub_region_slug_exists'            => 'Another sub-region in this community already uses that URL slug.',
    ...
    'caring_caregiver_status_invalid'          => 'The caregiver-link status filter is invalid.',
    'caring_caregiver_consent_required'        => 'Confirm that the care recipient consented before activating this relationship.',
    ...
    'shift_swap_fields_required' => 'A shift to swap from and a shift to swap to are both required',
    ...
    'shift_swap_no_one_on_shift' => 'Nobody is signed up for that shift yet, so there is no one to swap with',
    ...
    // Cross-cooperative hour transfers. Surfaced to members via
    // CaringCommunityApiController and to admins via AdminCaringCommunityController,
    // both of which pass $e->getMessage() into respondWithError().
    'caring_hour_transfer_hours_gt_zero' => 'Hours must be greater than zero.',
    'caring_hour_transfer_hours_precision' => 'Hours must have at most 2 decimal places.',
    'caring_hour_transfer_hours_over_limit' => 'Hours exceed the permitted single-transfer limit.',
    'caring_hour_transfer_destination_required' => 'Destination cooperative is required.',
    'caring_hour_transfer_source_member_not_found' => 'Source member not found.',
    'caring_hour_transfer_insufficient_hours' => 'Insufficient banked hours.',
    'caring_hour_transfer_destination_not_found' => 'Destination cooperative not found.',
    'caring_hour_transfer_destination_same_as_source' => 'Destination cooperative must be different from source.',
    'caring_hour_transfer_no_destination_member' => 'No matching member at destination cooperative — register there first.',
    'caring_hour_transfer_not_found' => 'Transfer not found.',
    'caring_hour_transfer_not_pending_approve' => 'Transfer is not pending and cannot be approved.',
    'caring_hour_transfer_destination_gone' => 'Destination cooperative no longer exists.',
    'caring_hour_transfer_peer_inactive' => 'Destination cooperative federation peer is not active.',
    'caring_hour_transfer_destination_member_gone' => 'No matching destination member — they may have removed their account.',
    'caring_hour_transfer_peer_no_secret' => 'Federation peer is missing a shared secret.',
    'caring_hour_transfer_no_longer_pending' => 'Transfer is no longer pending.',
    'caring_hour_transfer_source_hours_changed' => 'Source member no longer has enough banked hours.',
    ...
    'caring_hour_gift_self' => 'You cannot gift hours to yourself.',
    'caring_hour_gift_hours_gt_zero' => 'Hours must be greater than zero.',
    'caring_hour_gift_hours_precision' => 'Hours must have at most 2 decimal places.',
    'caring_hour_gift_message_too_long' => 'Message is too long.',
    'caring_hour_gift_sender_not_found' => 'Sender not found.',
    'caring_hour_gift_insufficient_hours' => 'Insufficient banked hours.',
    'caring_hour_gift_recipient_not_found' => 'Recipient not found.',
    'caring_hour_gift_not_found' => 'Gift not found.',
    'caring_hour_gift_no_longer_pending' => 'Gift is no longer pending.',
    'caring_hour_gift_recipient_only_accept' => 'Only the recipient can accept this gift.',
    'caring_hour_gift_recipient_only_decline' => 'Only the recipient can decline this gift.',
    'caring_hour_gift_sender_only_withdraw' => 'Only the sender can withdraw this gift.',
    'caring_hour_gift_not_pending_withdraw' => 'Only pending gifts can be withdrawn.',

    // Federation peer registration (admin-facing).
    'federation_peer_fields_required' => 'peer_slug, display_name, and base_url are required.',
    'federation_peer_slug_invalid' => 'peer_slug must be lowercase alphanumeric with hyphens.',
    'federation_peer_base_url_invalid' => 'base_url must be a valid HTTPS URL.',
