...
| [PLAY_RELEASE_PROCEDURE.md](docs/PLAY_RELEASE_PROCEDURE.md) | How a build actually reaches Google Play: internal testing → phone → promote, the version code Play already holds, and the measured review time. |
