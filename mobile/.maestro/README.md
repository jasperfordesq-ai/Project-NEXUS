...
| `13-effect-verifying-saved-collection.yaml` | Create and reopen a personal saved collection; CI independently verifies its owner, tenant, content, privacy and empty-item state | No (isolated login) |
