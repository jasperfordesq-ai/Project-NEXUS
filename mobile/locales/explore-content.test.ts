...
const english = require('./en/explore.json') as Record<string, unknown>;
const irish = require('./ga/explore.json') as Record<string, unknown>;
...
describe('mobile Irish Explore locale content', () => {
