...
describe('mobile Irish member profile discovery', () => {
  it('does not fall back to English except for reviewed functional values', () => {
    ...
    const reviewedPaths = [...englishFlat.keys()].filter((path) => path.startsWith('profile.'));
