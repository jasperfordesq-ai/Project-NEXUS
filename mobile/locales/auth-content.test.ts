...
const english = require('./en/auth.json') as Record<string, unknown>;
const irish = require('./ga/auth.json') as Record<string, unknown>;
...
describe('mobile Irish authentication locale content', () => {
