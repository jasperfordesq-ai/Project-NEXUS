...
<!-- doc-consistency: MOBILE_M1_CURRENT_SCORE=585/1000 -->
<!-- doc-consistency: MOBILE_BANKED_FLOOR=585 -->
...
**585 / 1000 on rubric M1.** The app is well-built code around a largely unproven product.
...
| --- | ---: | ---: | ---: | --- |
| Journey certification | 300 | 174 | 300 | Ledger overall credit **0.582** × 300 = 174.6. 47 CERTIFIED, 41 PROVEN, 24 RENDERS, 9 PARTIAL of 138 scoring rows. 🔴 The printed formula on this line and in the ledger had been stale since 2026-08-21 — it named 23 CERTIFIED and 26 RENDERS and its own arithmetic came to 55.30, which does not produce the quoted 0.520. The result was right; the shown working was not. Both are now restated from the ledger's summary row |
...
| Automated test depth | 100 | 70 | 100 | 317 suites / 2,191 tests (`npm test`, 2026-08-23), 0 skipped, 0 quarantined, 28 coverage floors, 12 source-scanning guards — and **zero automated device journeys**. Unchanged from 70: the new tests are real, but a suite that stayed green through the sheet outage AND through a missing half of the core exchange has not earned more credit |
...
🔴 **The floor is 585 and it ratchets.** A published total may never fall. If scope is
