...
<!-- doc-consistency: MOBILE_M1_CURRENT_SCORE=475/1000 -->
<!-- doc-consistency: MOBILE_BANKED_FLOOR=475 -->
...
**475 / 1000 on rubric M1.** The app is well-built code around a largely unproven product.
...
they fund an organisation; and of the 140 journeys in the ledger, 57 have still never been
...
| --- | ---: | ---: | ---: | --- |
| Journey certification | 300 | 101 | 300 | Ledger overall credit **0.336** × 300 = 100.9. 21 CERTIFIED, 29 PROVEN, 26 RENDERS, 5 PARTIAL of 138 scoring rows |
...
🔴 **The floor is 475 and it ratchets.** A published total may never fall. If scope is
