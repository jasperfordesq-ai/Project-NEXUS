...
<!-- doc-consistency: MOBILE_M1_CURRENT_SCORE=597/1000 -->
<!-- doc-consistency: MOBILE_BANKED_FLOOR=597 -->
...
**597 / 1000 on rubric M1.** The app is well-built code around a largely unproven product.
...
| --- | ---: | ---: | ---: | --- |
| Journey certification | 300 | 182 | 300 | Ledger overall credit **0.608** × 300 = 182.4. 50 CERTIFIED, 41 PROVEN, 24 RENDERS, 11 PARTIAL of 138 scoring rows. 🔴 The printed formula on this line and in the ledger had been stale since 2026-08-21 — it named 23 CERTIFIED and 26 RENDERS and its own arithmetic came to 55.30, which does not produce the quoted 0.520. The result was right; the shown working was not. Both are now restated from the ledger's summary row |
...
🔴 **The floor is 597 and it ratchets.** A published total may never fall. If scope is
