...
<!-- doc-consistency: MOBILE_M1_CURRENT_SCORE=547/1000 -->
<!-- doc-consistency: MOBILE_BANKED_FLOOR=547 -->
...
**547 / 1000 on rubric M1.** The app is well-built code around a largely unproven product.
...
| --- | ---: | ---: | ---: | --- |
| Journey certification | 300 | 154 | 300 | Ledger overall credit **0.513** × 300 = 153.9. 39 CERTIFIED, 41 PROVEN, 24 RENDERS, 4 PARTIAL of 138 scoring rows |
...
| Automated test depth | 100 | 70 | 100 | 309 suites / 2,111 tests, 0 skipped, 0 quarantined, 28 coverage floors, 12 source-scanning guards — and **zero automated device journeys**. Unchanged from 70: the new tests are real, but a suite that stayed green through the sheet outage AND through a missing half of the core exchange has not earned more credit |
...
🔴 **The floor is 547 and it ratchets.** A published total may never fall. If scope is
