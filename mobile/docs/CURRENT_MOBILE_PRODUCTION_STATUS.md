...
<!-- doc-consistency: MOBILE_M1_CURRENT_SCORE=588/1000 -->
<!-- doc-consistency: MOBILE_BANKED_FLOOR=588 -->
...
**588 / 1000 on rubric M1.** The app is well-built code around a largely unproven product.
...
| Automated test depth | 100 | 70 | 100 | 318 suites / 2,200 tests (`npm test`, 2026-08-23), 0 skipped, 0 quarantined, 28 coverage floors, 13 source-scanning guards — and **zero automated device journeys**. Unchanged from 70: the new tests are real, but a suite that stayed green through the sheet outage AND through a missing half of the core exchange has not earned more credit |
...
🔴 **The floor is 588 and it ratchets.** A published total may never fall. If scope is
