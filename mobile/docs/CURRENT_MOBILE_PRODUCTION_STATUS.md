...
<!-- doc-consistency: MOBILE_M1_CURRENT_SCORE=513/1000 -->
<!-- doc-consistency: MOBILE_BANKED_FLOOR=513 -->
...
**513 / 1000 on rubric M1.** The app is well-built code around a largely unproven product.
...
they fund an organisation; and of the 140 journeys in the ledger, 44 have still never been
...
| --- | ---: | ---: | ---: | --- |
| Journey certification | 300 | 120 | 300 | Ledger overall credit **0.401** × 300 = 120.2. 23 CERTIFIED, 41 PROVEN, 26 RENDERS, 4 PARTIAL of 138 scoring rows |
...
🔴 **The floor is 513 and it ratchets.** A published total may never fall. If scope is
