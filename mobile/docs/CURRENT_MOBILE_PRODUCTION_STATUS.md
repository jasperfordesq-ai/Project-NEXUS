...
<!-- doc-consistency: MOBILE_M1_CURRENT_SCORE=521/1000 -->
<!-- doc-consistency: MOBILE_BANKED_FLOOR=521 -->
...
**521 / 1000 on rubric M1.** The app is well-built code around a largely unproven product.
...
they fund an organisation; and of the 140 journeys in the ledger, 41 have still never been
...
| --- | ---: | ---: | ---: | --- |
| Journey certification | 300 | 128 | 300 | Ledger overall credit **0.428** × 300 = 128.4. 27 CERTIFIED, 41 PROVEN, 25 RENDERS, 4 PARTIAL of 138 scoring rows |
...
| Automated test depth | 100 | 70 | 100 | 308 suites / 2,083 tests, 0 skipped, 0 quarantined, 28 coverage floors, 12 source-scanning guards — and **zero automated device journeys**. Unchanged from 70: the new tests are real, but a suite that stayed green through the sheet outage AND through a missing half of the core exchange has not earned more credit |
...
🔴 **The floor is 521 and it ratchets.** A published total may never fall. If scope is
