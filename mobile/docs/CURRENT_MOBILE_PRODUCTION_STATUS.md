...
<!-- doc-consistency: MOBILE_M1_CURRENT_SCORE=549/1000 -->
<!-- doc-consistency: MOBILE_BANKED_FLOOR=549 -->
...
**549 / 1000 on rubric M1.** The app is well-built code around a largely unproven product.
...
| --- | ---: | ---: | ---: | --- |
| Journey certification | 300 | 156 | 300 | Ledger overall credit **0.520** × 300 = 156.1. 40 CERTIFIED, 41 PROVEN, 24 RENDERS, 4 PARTIAL of 138 scoring rows |
...
🔴 **The floor is 549 and it ratchets.** A published total may never fall. If scope is
