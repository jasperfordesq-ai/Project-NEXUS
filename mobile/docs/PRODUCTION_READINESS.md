...
| 9 | Visual correctness | **Weak** | Contrast gated (37 assertions, found 7 real failures); 3 screens pixel-gated at 0px. First visual sweep run 2026-08-19 (16 screens): found and fixed an invisible-icon bug on every listing card, and identified two clashing brand colours as the reason the app looks off — see [VISUAL_AUDIT.md](VISUAL_AUDIT.md). ~121 screens still unphotographed; dark mode unswept |
