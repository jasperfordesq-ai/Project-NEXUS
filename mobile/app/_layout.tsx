...
function ThemedShell() {
  ...
  // Native SafeAreaView does not consume JavaScript inset overrides. Reserve
  // the measured banner height in layout; screens retain their usual safe area.

  return (
    <>
      <StatusBar style={scheme === 'dark' ? 'light' : 'dark'} />
      <ThemeProvider value={navTheme}>
        <View style={{ flex: 1, paddingTop: offlineBannerHeight }}>
          <RootNavigator />
        </View>
      </ThemeProvider>
  ...
  return (
    <Stack screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen
        ...
        options={{ ...modalOptions, headerShown: false, title: t('events:analytics.title') }}
      />
      <Stack.Screen
      ...
      />
      <Stack.Screen
        name="(modals)/event-registration-submissions"
        options={{ ...modalOptions, headerShown: false, title: t('eventRegistration:submissions.title') }}
      />
      <Stack.Screen
        name="(modals)/event-registration-guests"
        options={{ ...modalOptions, headerShown: false, title: t('eventRegistration:guests.title') }}
      />
      <Stack.Screen
        name="(modals)/event-registration-invitations"
        options={{ ...modalOptions, headerShown: false, title: t('eventRegistration:invitations.builder_title') }}
      />
      <Stack.Screen
        name="(modals)/event-registration-retention"
        options={{ ...modalOptions, headerShown: false, title: t('eventRegistration:retention.title') }}
      />
      <Stack.Screen
        name="(modals)/event-invitation-recipients"
        options={{ ...modalOptions, headerShown: false, title: t('eventRegistration:revocation.title') }}
      />
      <Stack.Screen
      ...
      */}
      ...
      />
      <Stack.Screen
        name="(modals)/marketplace-deliveries"
        options={{ ...modalOptions, headerShown: false, title: t('marketplace:communityDelivery.title') }}
      />
      <Stack.Screen
