  ...
  return <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
    <ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={{ padding: 16, paddingBottom: 48 }}>
      <View className="gap-4">
        ...
        <Button variant="secondary" isDisabled={!permitted || operation.busy} onPress={() => router.push({ pathname: '/(modals)/event-invitation-recipients', params: { id: String(eventId) } } as Href)}>{t('eventRegistration:revocation.title')}</Button>
