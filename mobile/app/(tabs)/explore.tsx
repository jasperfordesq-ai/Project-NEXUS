...
const SECTION_META: SectionMeta[] = [
  ...
  { key: 'groups', titleKey: 'sections.groups.title', subtitleKey: 'sections.groups.subtitle', icon: 'people-outline', tone: '#06b6d4', tab: 'groups', featureGate: 'groups', seeAllRoute: '/(modals)/groups' as Href },
  { key: 'people', titleKey: 'sections.people.title', subtitleKey: 'sections.people.subtitle', icon: 'person-add-outline', tone: '#6366f1', tab: 'people', featureGate: 'connections', seeAllRoute: '/(modals)/members' as Href },
