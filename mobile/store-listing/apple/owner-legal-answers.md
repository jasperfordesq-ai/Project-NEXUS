...
| Are promotional push notifications optional? | **Yes** | The separate paid-promotion preference is default-off, can be withdrawn in Settings, and does not control ordinary service notifications. Native non-promotional alerts use generic lock-screen wording and keep detailed content in the authenticated app. |
