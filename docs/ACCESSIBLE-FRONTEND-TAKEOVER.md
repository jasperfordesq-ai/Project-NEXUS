...
Current score: **845/1000** under rubric `WEBUK-W2-PROD-R1` (rescored 2026-08-13,
651 -> 710 -> 745 -> 730 -> 830 -> 836 -> 845). See the scoring
...
|---|---|---|---|---|
| `web-uk` production readiness | `WEBUK-W2-PROD-R1` | 845/1000 | Is `web-uk` safe to serve, and can Blade retire? | **Current** — read it from `web-uk/docs/CURRENT_WEBUK_PRODUCTION_STATUS.md`, never from here |
...
🔴 **The current 845 exceeds the retired 663, and the two are still not comparable.** The
