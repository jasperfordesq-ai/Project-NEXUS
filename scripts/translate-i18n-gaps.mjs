...
const LANGUAGE_IDENTICAL_VALUE_ALLOWLIST = {
  ...
  ga: new Set([
    ...
    'OS Places (PSGA)',
    'Jane...',
    // Reviewed 2026-08-17: people, brands, platforms, protocol labels,
    // keyboard labels, plan names, currency displays, and typography terms.
    // These are intentionally unchanged in Irish and are key/value pinned by
    // irish-react-reviewed-invariants.json so this value-level list cannot
    // conceal a new user-facing English fallback.
    'Monica',
    'Elaine',
    'Port',
    'Stripe',
