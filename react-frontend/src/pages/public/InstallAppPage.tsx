...
export function InstallAppPage() {
  ...
  const appTypes = [
    ...
    },
    {
      ...
      icon: Package,
      tone: 'text-amber-500',
      toneBg: 'from-amber-500/20 to-amber-500/5',
      title: t('install_app.type_android_title'),
      tag: t('install_app.type_android_tag'),
      tagColor: 'warning' as const,
      body: t('install_app.type_android_body', { name: appName }),
      note: t('install_app.type_android_status'),
    },
    {
      id: 'stores',
      icon: Store,
      ...
      title: t('install_app.type_stores_title'),
      tag: t('install_app.type_stores_tag'),
      tagColor: 'default' as const,
      body: t('install_app.type_stores_body', { name: appName }),
    },
  ];
        ...
        <GlassCard className="p-5 sm:p-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-xl border border-emerald-500/30 bg-emerald-500/5 p-4">
              <p className="mb-2 flex items-center gap-2 text-sm font-semibold text-emerald-600 dark:text-emerald-400">
            ...
            <div className="rounded-xl border border-amber-500/30 bg-amber-500/5 p-4">
              ...
              <p className="text-sm text-theme-secondary">
                {t('install_app.status_issues_apple')}
              </p>
            </div>
          </div>
      ...
      <motion.section variants={itemVariants} aria-labelledby="install-types-heading">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {appTypes.map((type) => {
            ...
            return (
              <GlassCard key={type.id} className="flex h-full flex-col gap-3 p-5">
