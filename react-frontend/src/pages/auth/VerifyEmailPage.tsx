            ...
            {requiresApproval && !isAuthenticated && (
              <div className="p-3 rounded-xl bg-amber-500/10 border border-amber-500/20 text-sm text-left mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-theme-warning">{t('verify_email.awaiting_approval_title')}</p>
      ...
      >
        <GlassCard className="p-8 text-center">
          ...
          <div className="flex flex-col gap-3">
            ...
            {isAuthenticated ? (
              resendSuccess ? (
                <div role="status" className="p-3 rounded-lg bg-emerald-500/20 border border-emerald-500/30 text-theme-success text-sm">
