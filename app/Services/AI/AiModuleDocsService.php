...
class AiModuleDocsService
{
    ...
    public static function defaultSeed(): array
    {
        return [
            ...
            'group_exchanges' => [
                // Rewritten 2026-09-26: the previous body described a 'beneficiary',
                // payment 'from a community pool' and per-contributor actual hours,
                // none of which exist. Communities seeded before then are corrected
                // by migration 2026_09_26_150000_correct_group_exchange_ai_module_doc.
                'title' => 'Group exchanges — one exchange, many people',
                'body' => "Group Exchanges (/group-exchanges) record one time-credit exchange with several people in it, instead of many separate transfers. For example, a workshop or a garden workday.\n\nSetting one up: give it a title, an optional description and the number of hours. Add the people taking part. Each is a Provider (gives their time and earns hours) or a Receiver (benefits and gives hours). You need at least one of each.\n\nThree ways to share the hours:\n• Equal Split: shared equally among the providers, and equally among the receivers.\n• Custom Hours: set exactly how many hours each person gives or earns. Hours given must equal hours earned.\n• Weighted Split: shared in proportion to a weight given to each person.\n\nConfirming: when the organiser starts the exchange, everyone is asked to confirm their hours. Any change means everyone confirms again. Once all have confirmed, the organiser completes it and every balance updates at once. If anyone giving hours does not have enough, nothing moves. It can be cancelled before completion.\n\nWorkshops: a common approach is a 'Community Pot' member account. The leader earns 1 hour, each attendee gives 1 hour, and the rest goes to the pot.",
                'keywords' => ['group exchange', 'group exchanges', 'project', 'team project', 'collaborative', 'collaboration', 'work party', 'community project', 'workshop', 'community pot', 'split hours'],
            ],
            'federation' => [
