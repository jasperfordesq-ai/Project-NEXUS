...
class EmailTriggerAuditService
{
    ...
    public function eventMatrix(): array
    {
        return [
            ...
            ['module' => 'admin_notifications', 'event' => 'admin_new_volunteer_organisation', 'category' => 'admin_new_volunteer_organisation', 'critical' => false, 'source_table' => 'email_log'],
            ['module' => 'volunteering', 'event' => 'volunteer_organisation_approved', 'category' => 'volunteer_organisation_approved', 'critical' => true, 'source_table' => 'email_log'],
            ['module' => 'volunteering', 'event' => 'volunteer_organisation_declined', 'category' => 'volunteer_organisation_declined', 'critical' => true, 'source_table' => 'email_log'],
            ['module' => 'volunteering', 'event' => 'volunteer_organisation_suspended', 'category' => 'volunteer_organisation_suspended', 'critical' => true, 'source_table' => 'email_log'],
            ['module' => 'volunteering', 'event' => 'volunteer_organisation_reinstated', 'category' => 'volunteer_organisation_reinstated', 'critical' => false, 'source_table' => 'email_log'],
