...
[![Version](https://img.shields.io/badge/version-1.5.9-success.svg)](CHANGELOG.md)
...
This is **version 1.5.9 — generally available**, in active production use. Per-module maturity (GA / Beta / Preview) is published on the in-app `/features` page and the public Changelog:
